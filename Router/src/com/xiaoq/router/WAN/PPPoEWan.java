...
public class PPPoEWan {
	...
	public void testPPPoEWAN() throws InterruptedException {
		...
		type.selectByValue("pppoe");
		
		WebElement ipaddr = driver.findElement(By.id("PPPOES_USER"));
		ipaddr.clear();
		ipaddr.sendKeys("test");
		
		WebElement ipmask = driver.findElement(By.id("PPPOES_PASSWORD"));
		ipmask.clear();
		ipmask.sendKeys("test");
